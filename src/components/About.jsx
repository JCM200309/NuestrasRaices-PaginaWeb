          ...
          <div>
            ...
            <div className="mt-8">
              <p className="text-lg text-brown-light mb-6">
                En <strong className="text-brown-dark">Nuestras Raíces</strong> brindamos un espacio seguro, cálido y confortable donde cada residente recibe una atención personalizada. Trabajamos para que cada día esté acompañado de bienestar, respeto y calidad humana.
              </p>
              <p className="text-lg text-brown-light mb-6">
