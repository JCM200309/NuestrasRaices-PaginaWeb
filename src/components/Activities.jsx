...
const tabs = [
  ...
  },
  {
    ...
    items: ["Yoga de acuerdo a las posibilidades", "Gimnasia Grupal", "Ejercicios de Equilibrio", "Caminatas guiadas"],
  ...
  },
  {
    ...
    items: ["Taller de Arte (Pintura y Dibujo)", "Musicoterapia", "Taller de Tango y Folklore", "Talleres Musicales con Instrumentos"],
