...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/ajax/nuestrasraices98@hotmail.com", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="bg-white p-10 rounded-3xl shadow-sm border border-brown-light/8">
            ...
            {feedback.message && (
              <div
                className={`p-3 rounded-md text-sm font-semibold mb-5 ${feedback.type === "success"
